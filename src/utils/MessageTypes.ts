...
export const photoMessage: MessageType = {
    ...
    data: {
        uri: 'https://i.ibb.co/BPYfLms/Screenshot-2024-07-30-at-2-43-22-PM.png',
        status: {
            click: true,
            loading: 1,
...
export const sentTextMessage: MessageType = {
    type: 'text',
    id: String(Math.random()),
    position: 'right',
    text: 'Sure!',
